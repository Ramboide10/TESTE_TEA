# -*- coding: utf-8 -*-
"""Codigo_Publico.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1v_Zje9SFj8vVg7WNpsXNXNDz1oOA9xXU
"""
...
# Função para buscar os dados mais recentes do Google Sheets público
def get_latest_form_data():
    url_csv = f'https://docs.google.com/spreadsheets/d/{SHEET_ID}/export?format=csv&id={SHEET_ID}&gid=0'
